    ...
    return (
        <View style={styles.container}>
            <View style={styles.containerHeader}>
                <Text style={styles.abrirText}>Perfil</Text>
                <TouchableOpacity style={styles.backButton} onPress={() => navigation.navigate('MenuAdmin')}>
            ...
            <View style={styles.containerForm}>
                <View style={styles.containerDados}>
                    ...
                    <Text style={styles.formularioR}>CATEGORIA</Text>
                ...
                <View style={styles.containerDados}>
                    ...
                    <TouchableOpacity>
                    <Text style={styles.alterarSenha}>Alterar</Text>
                    </TouchableOpacity>
            ...
            <TouchableOpacity onPress={pickDocument}>
                    <Text style={styles.alterarFoto}>Alterar</Text>
                </TouchableOpacity>
        </View>
    );
}
