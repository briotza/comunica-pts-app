    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.criarButton}>
                    <TouchableOpacity style={styles.cadastroButtons}
                        onPress={() => navigation.navigate('CriarCadastroAdmin')}>
                        <Text style={styles.menuText}>CRIAR CADASTRO</Text>
                    </TouchableOpacity>
                </View>
            ...
            <View style={styles.containerForm}>
                ...
                <View style={styles.button}>
                    <TouchableOpacity style={styles.cadastroButtons}
                        onPress={() => navigation.navigate('LoginResidentesAdmin')}>
                        <Text style={styles.menuText}>RESIDENTES</Text>
                    </TouchableOpacity>
                </View>
                <View style={styles.button}>
                    <TouchableOpacity style={styles.cadastroButtons}
                        onPress={() => navigation.navigate('LoginDticAdmin')}>
                        <Text style={styles.menuText}>DTIC</Text>
                    </TouchableOpacity>
                </View>
                <View style={styles.button}>
                    <TouchableOpacity style={styles.cadastroButtons}
                        onPress={() => navigation.navigate('LoginDopAdmin')}>
                        <Text style={styles.menuText}>DOP</Text>
                    </TouchableOpacity>
                </View>
                <View style={styles.button}>
                    <TouchableOpacity style={styles.cadastroButtons}
                        onPress={() => navigation.navigate('LoginDafAdmin')}>
