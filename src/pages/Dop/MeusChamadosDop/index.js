...
export default function MeusChamadosDop() {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.containerHeader}>
                ...
                <TouchableOpacity style={styles.backButton} onPress={() => navigation.navigate('MenuDop')}>
            ...
            <ScrollView style={styles.containerBusca}>
                ...
                onPress={() => navigation.navigate('ChamadoDop')}>
